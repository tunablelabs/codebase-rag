...
def load_embedding_model(api_key: str) -> callable:
    """
    ...
    # embedding_model = lambda text: openai.Embedding.create(input=text, engine='text-embedding-ada-002')
...
def create_parent_retriever(
    docs: List[Document], embeddings_model: lambda text: openai.Embedding.create(input=text, engine='text-embedding-ada-002')):
    """
...
def main(
    ...
    embedding_model = load_embedding_model(api_key=os.getenv('OPENAI_API_KEY'))
